...
//        FileWriter.addUser(new Organizer("10", "a", "a", "a", "a", "a"));    //edit the list in memory
//        FileWriter.addUser(new Organizer("11", "a", "a", "a", "a", "a"));    //edit the list in memory
//        FileWriter.addUser(new Guest("12", "a", "a", "a", "a", "a"));    //edit the list in memory
//        FileWriter.persistUsers();  //write it to the file
//
//        Wedding wed = new Wedding(new Date(1,1,2000), "here", 20000, 200, "a");
//        wed.addTask(new Task(new Date(1,1,1999), "descript"));
//        FileWriter.addWedd(wed);
